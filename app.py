...
housing = st.selectbox("Housing Loan", list(housing_options.keys()))
loan = st.selectbox("Personal Loan", list(loan_options.keys()))
...
was_previously_contacted = st.selectbox("Previously Contacted?", list(contacted_options.keys()))
